...
## Summary
- 7916 nodes · 8140 edges · 1104 communities (988 shown, 116 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 570 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f9045bfc`
...
1. `Communities (1095 total, 115 thin omitted)` - 533 edges
2. `New()` - 121 edges
3. `main()` - 51 edges
...
9. `Worker` - 21 edges
10. `setupAuditTestRoutes()` - 20 edges
...
## Communities (1104 total, 116 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.12
Nodes (27): LoginPage(), LoginPost(), Logout(), Echo, Pool, T, Context, WorkspaceRepository (+19 more)
...
Cohesion: 0.04
Nodes (47): 0. Git Branch Invariant, 10. Spawn gsd-plan-checker Agent, 11. Handle Checker Return, 11a. Filesystem Fallback (Checker), 12.5. Plan Bounce (Optional External Refinement), 12. Revision Loop (Max 3 Iterations), 13. Requirements Coverage Gate, 13a. Decision Coverage Gate (+39 more)
...
Cohesion: 0.05
Nodes (43): Alternatives Considered, Anti-Patterns to Avoid, Applicable ASVS Categories, Architectural Responsibility Map, Architecture Patterns, Assumptions Log, Code Examples, Common Pitfalls (+35 more)

### Community 10 - "Community 10"
Cohesion: 0.06
Nodes (27): Header, Context, Duration, MessagePayload, Pool, T, UUID, Context (+19 more)
...
Cohesion: 0.16
Nodes (24): New(), TestMessageHandler_CreateWithMedia(), testContext(), TestCreateMessageInvalidChannel(), TestCreateMessageInvalidFallbackChannels(), TestCreateMessageInvalidJSON(), TestCreateMessageMissingAuth(), TestCreateMessageMissingTo() (+16 more)

### Community 13 - "Community 13"
Cohesion: 0.05
Nodes (37): Check 8a — Automated Verify Presence, Check 8b — Feedback Latency Assessment, Check 8c — Sampling Continuity, Check 8d — Wave 0 Completeness, Check 8e — VALIDATION.md Existence (Gate), Dimension 11: Research Resolution (#1602), Dimension 12: Pattern Compliance (#1861), Dimension 1: Requirement Coverage (+29 more)
...
Cohesion: 0.06
Nodes (46): envOrDefault(), Load(), NewEncryptor(), Encryptor, connectNATS(), TestWABAWebhook_Inbound(), Conn, T (+38 more)

### Community 16 - "Community 16"
Cohesion: 0.06
Nodes (35): Additional Commands, Capturing Ideas, Notes, and Todos, Common Workflows, Configuration, Core Workflow, Debugging, Diagnostics & Maintenance, Discovery & Specification (+27 more)
...
Cohesion: 0.06
Nodes (31): 1. WABA Integration Details, 2. Telegram Bot Integration Details, 3. Template Management DB Schema & CRUD, 4. 24h Customer Service Window Tracking, 5. Fallback and Terminal Errors, 6. Validation Architecture, A. Success Response (HTTP 200 OK), A. Text Message Payload (+23 more)
...
Cohesion: 0.17
Nodes (16): Event, NewEvent(), Querier, NewQuerier(), RecentEntry, getTestPool(), TestInboundAuditLogging(), TestTelegramWebhookHandler() (+8 more)

### Community 27 - "Community 27"
Cohesion: 0.09
Nodes (27): getTestPool(), TestWABATemplateHandler(), T, Pool, T, Pool, T, DB (+19 more)
...
Cohesion: 0.05
Nodes (39): Client, Context, DB, Device, JID, Logger, CancelFunc, Consumer (+31 more)

### Community 30 - "Community 30"
Cohesion: 0.07
Nodes (27): Alternatives Considered, Architecture, Constraints, Conventions, --- Core (go.mod) ---, Core Technologies, --- Dev / test ---, Developer Profile (+19 more)
...
Cohesion: 0.07
Nodes (27): Detect Test Infrastructure, Identify Wave 0 Gaps, Map Requirements to Tests, Package Legitimacy Gate, Research Blocked, Research Complete, RESEARCH.md Structure, Research Plan via Code Seam (+19 more)
...
Cohesion: 0.07
Nodes (26): Anti-Patterns and Extended Examples, Authentication Gates, Checkpoint Types, Context Budget for TDD, Context Budget Rules, Context Section Rules, CRITICAL: Never Simplify User Decisions — Split Instead, CRITICAL: User Decision Fidelity (+18 more)
...
Cohesion: 0.16
Nodes (18): Context, JID, Pool, Time, UUID, T, Row, Rows (+10 more)
...
Cohesion: 0.12
Nodes (20): T, Int, Context, Context, Mutex, Listener, DebugServer, RegisterCounter() (+12 more)
...
Cohesion: 0.20
Nodes (11): Encryptor, Context, Pool, Time, UUID, T, NewWebhookDLQRepository(), TestWebhookDLQRepository() (+3 more)
...
Cohesion: 0.20
Nodes (20): Pool, T, HashAPIKey(), hmacEqual(), VerifyAPIKey(), APIKeyRepository, MiddlewareFunc, AuthMiddleware() (+12 more)

### Community 53 - "Community 53"
Cohesion: 0.00
Nodes (533): Communities (1095 total, 115 thin omitted), Community 0 - "Community 0", Community 100 - "Community 100", Community 101 - "Community 101", Community 102 - "Community 102", Community 103 - "Community 103", Community 104 - "Community 104", Community 105 - "Community 105" (+525 more)
...
Cohesion: 0.09
Nodes (21): Add After Validation (v1.x) — Once Core Outbound Is Proven, Anti-Features (Commonly Requested, Often Problematic), Competitor Feature Analysis, Confirmed Well-Covered (no action), Coverage Gap Analysis vs Existing PRD, Deliberate Exclusions (confirmed, keep), Dependency Notes, Differentiators (Competitive Advantage) (+13 more)
...
Cohesion: 0.20
Nodes (14): WorkspaceHandler, APIKeyRepository, Context, WorkspaceRepository, WorkspaceCreateForm(), WorkspaceDeleteConfirm(), WorkspaceDetailContent(), WorkspaceDetailPage() (+6 more)
...
Cohesion: 0.10
Nodes (19): Automatable Quick Reference, ❌ BAD: Asking human to deploy / ✅ GOOD: the agent automates, ❌ BAD: Asking user to copy values between services, ❌ BAD: Asking user to run CLI commands, ❌ BAD: Asking user to start dev server, ❌ BAD: Too many checkpoints / ✅ GOOD: Single checkpoint, ❌ BAD: Vague verification / ✅ GOOD: Specific steps, checkpoint:decision (9%) (+11 more)
...
Cohesion: 0.10
Nodes (19): Architecture Approach, Confidence Assessment, Critical Pitfalls, Executive Summary, Expected Features, Gaps to Address, Implications for Roadmap, Key Findings (+11 more)
...
Cohesion: 0.15
Nodes (12): wabaTemplate, wabaComponent, wabaLanguage, wabaParameter, wabaText, wabaComponent, WABAConfig, wabaLanguage (+4 more)
...
Cohesion: 0.11
Nodes (17): 24-Hour Customer Service Window Tracking, Canonical References, Deferred Ideas, Established Patterns, Existing Code Insights, Fallback Mechanism & Ordered Fallback, Implementation Decisions, Integration Points (+9 more)
...
Cohesion: 0.23
Nodes (10): Context, Pool, Time, UUID, T, RawMessage, NewWABATemplateRepository(), TestWABATemplateRepository() (+2 more)

### Community 90 - "Community 90"
Cohesion: 0.24
Nodes (15): Base(), Sidebar(), DLQBadgeFragment(), DLQDetailModal(), DLQTable(), WebhooksContent(), WebhooksPage(), WorkspaceWebhooksContent() (+7 more)
...
Cohesion: 0.11
Nodes (17): Critical Pitfalls, Integration Gotchas, "Looks Done But Isn't" Checklist, Performance Traps, Pitfall 1: WhatsApp actively bans whatsmeow-connected accounts (not just "protocol changes"), Pitfall 2: At-least-once delivery sends the same WhatsApp message to a human twice, Pitfall 3: Goroutine leaks from forgotten senders and untracked session lifetimes, Pitfall 4: Audit write contention breaches the 50ms p99 ingestion budget (+9 more)

### Community 94 - "Community 94"
Cohesion: 0.12
Nodes (16): API Key Management, Audit Log Review, Deferred Ideas, Established Patterns, Existing Code Insights, HTMX Fragment Strategy, Implementation Decisions, Integration Points (+8 more)

### Community 95 - "Community 95"
Cohesion: 0.22
Nodes (7): NewWebhookDLQHandler(), WebhookDLQHandler, Context, JetStreamPublisher, WebhookDLQ, WebhookDLQRepository, WorkspaceRepository
...
Cohesion: 0.09
Nodes (27): InboundContact, InboundEventPayload, InboundLocation, InboundMedia, ValueData, ValueStruct, contentHash(), NewWABAWebhookHandler() (+19 more)

### Community 99 - "Community 99"
Cohesion: 0.23
Nodes (10): LoadDefaultConfig(), WithCredentialsProvider(), WithRegion(), LoadOptions, CredentialsProvider, T, Config, Context (+2 more)
...
Cohesion: 0.12
Nodes (15): Canonical References, Deferred Ideas, Established Patterns, Existing Code Insights, Implementation Decisions, Inbound Ingestion & NATS Routing, Integration Points, Phase 7: Media & Inbound - Context (+7 more)
...
Cohesion: 0.08
Nodes (25): Admin, API, Audit, Authentication, Compliance, Fallback, Inbound, Infrastructure (+17 more)

### Community 109 - "Community 109"
Cohesion: 0.16
Nodes (20): Map, MiddlewareFunc, UUID, T, Limit, Limiter, QueueDepthTracker, NewQueueDepthTracker() (+12 more)
...
Cohesion: 0.13
Nodes (14): API Design, Backpressure, Deferred Ideas, Established Patterns, Existing Code Insights, Implementation Decisions, Integration Points, Message TTL (+6 more)

### Community 115 - "Community 115"
Cohesion: 0.13
Nodes (14): Deferred Ideas, DLQ & Admin UI, Established Patterns, Existing Code Insights, Implementation Decisions, Integration Points, Phase 6: Webhook Delivery & DLQ - Context, Phase Boundary (+6 more)
...
Cohesion: 0.20
Nodes (11): Client, GetObjectInput, GetObjectOutput, Options, PutObjectInput, PutObjectOutput, NewFromConfig(), Config (+3 more)

### Community 119 - "Community 119"
Cohesion: 0.28
Nodes (13): mockDispatcher, NewRegistry(), TestMockDispatcherTerminalError(), TestNewRegistryCopiesMap(), TestRegistryConcurrentAccess(), TestRegistryGet(), TestRegistryGetOrDefault(), TestRegistryLen() (+5 more)

### Community 120 - "Community 120"
Cohesion: 0.19
Nodes (11): Context, UUID, Context, T, UUID, RecipientSession, mockSessionReader, RecipientSessionReader (+3 more)
...
Cohesion: 0.14
Nodes (13): Audit Partitioning, Credential Encryption, Graceful Shutdown Order, Key Architectural Decisions, Migration Strategy, Observability, Out of Scope for Phase 1, Phase 1: Foundation — Phase Context (+5 more)

### Community 124 - "Community 124"
Cohesion: 0.14
Nodes (13): Deferred Ideas, Established Patterns, Existing Code Insights, Implementation Decisions, Integration Points, Phase 4: WhatsApp Web & QR Pairing - Context, Phase Boundary, QR Pairing & Admin UI (+5 more)
...
Cohesion: 0.35
Nodes (8): Context, Pool, RWMutex, Time, UUID, APIKey, APIKeyRepository, cacheEntry

### Community 131 - "Community 131"
Cohesion: 0.12
Nodes (20): NewMediaHandler(), MediaHandler, Context, S3Client, Context, Context, Pool, T (+12 more)
...
Cohesion: 0.26
Nodes (8): Client, Context, CredentialsRepository, MessagePayload, MetaErrorResponse, NewWABAAdapter(), WABAAdapter, WindowChecker
...
Cohesion: 0.14
Nodes (13): Overview, Phase 07.1: Close gap: v1.0 audit gaps (INSERTED), Phase 1: Foundation, Phase 2: Admin Shell, Phase 3: Ingest API & Queue, Phase 4: WhatsApp Web & QR Pairing, Phase 5: Official Channels & Smart Fallback, Phase 6: Webhook Delivery & DLQ (+5 more)

### Community 171 - "Community 171"
Cohesion: 0.15
Nodes (12): Alternatives Considered, Core Technologies, Development Tools, Installation, PRD Stack Validation — Executive Summary, Recommended Stack, Sources, Stack Patterns by Variant (+4 more)

### Community 172 - "Community 172"
Cohesion: 0.17
Nodes (11): Architectural Responsibility Map, Assumptions Log, Don't Hand-Roll, Environment Availability, Metadata, Open Questions, Package Legitimacy Audit, Phase 1: Foundation — Research (+3 more)
...
Cohesion: 0.35
Nodes (9): Context, Pool, Time, UUID, buildWhereClause(), NewAuditRepository(), AuditEntry, AuditFilters (+1 more)
...
Cohesion: 0.18
Nodes (10): Accomplishments, Decisions Made, Deviations from Plan, Files Created/Modified, Issues Encountered, Next Phase Readiness, Performance, Phase 3 Plan 01: Unified POST /messages Endpoint Summary (+2 more)

### Community 203 - "Community 203"
Cohesion: 0.18
Nodes (10): Created, Files Created/Modified, Modified, Phase 05-official-channels-smart-fallback Plan 02 - Summary, Summary of Changes, Task 1: Migration and repository for waba_templates table, Task 2: Extend message models and WABA adapter for template-based sending, Task 3: WABA template CRUD and Sync REST endpoints (+2 more)

### Community 204 - "Community 204"
Cohesion: 0.18
Nodes (10): Created, Files Created/Modified, Modified, Phase 5: Official Channels & Smart Fallback - Plan 03 Completion Summary, Task 1: Migration and repository for `recipient_sessions` table, Task 2: WABA 24-hour customer window checking logic, Task 3: Telegram inbound webhook token validation and upsert, Task 4: Inbound session updates for whatsmeow WhatsApp Web (+2 more)

### Community 205 - "Community 205"
Cohesion: 0.18
Nodes (10): Created, Files Created/Modified, Modified, Phase 5: Official Channels & Smart Fallback - Plan 04 Completion Summary, Task 1: Migration and repository for `message_dispatches` table, Task 2: Ingest handler and queue message payload updates, Task 3: Worker fallback dispatch loop implementation, Task 4: Integration testing of worker fallback loop (+2 more)

### Community 206 - "Community 206"
Cohesion: 0.18
Nodes (10): 1. Configure Webhook Endpoint, 2. Webhook Replay Prevention Header, 3. Webhook Payload Schema, 4. Dead-Letter Queue (DLQ) Logging, 5. Admin DLQ Dashboard, 6. Manual Retry and Deletion, Current Test, Gaps (+2 more)
...
Cohesion: 0.18
Nodes (10): Auto-Group by Design Area, Copy Source Files, Curate Sketches One-at-a-Time, Determine Output Skill Name, Gather Sketch Inventory, ▶ Next Up, Synthesize Reference Files, Write Planning Summary (+2 more)
...
Cohesion: 0.20
Nodes (8): Dispatcher, MessagePayload, TemplateComponent, TemplateParameter, TerminalError, TemplateComponent, TemplateParameter, Media

### Community 220 - "Community 220"
Cohesion: 0.07
Nodes (33): MessageHandler, Publisher, NewTelegramWebhookHandler(), telegramAudio, telegramChat, telegramConfig, telegramContact, telegramDocument (+25 more)

### Community 221 - "Community 221"
Cohesion: 0.40
Nodes (16): Cookie, Echo, T, UUID, createTestWorkspace(), loginAndGetCookie(), setupWorkspaceRoutes(), TestAdminAPIKeyConfirmRevoke() (+8 more)

### Community 222 - "Community 222"
Cohesion: 0.36
Nodes (6): Context, Pool, Time, UUID, Workspace, WorkspaceRepository
...
Cohesion: 0.20
Nodes (9): 3a. ROOT CAUSE FOUND, 3b. TDD CHECKPOINT, 3c. DEBUG COMPLETE, 3d. CHECKPOINT REACHED, 3e. INVESTIGATION INCONCLUSIVE, Step 1: Read Debug File, Step 2: Spawn gsd-debugger Agent, Step 3: Handle Agent Return (+1 more)
...
Cohesion: 0.20
Nodes (9): 5. Resilience & Error Handling, Backpressure (concrete), Circuit breakers, Error wrapping convention, Graceful shutdown, HTTP status mapping, Observability (resilience-relevant), Retries (+1 more)
...
Cohesion: 0.18
Nodes (12): NewTerminalError(), Client, Context, CredentialsRepository, MessagePayload, S3Client, Request, NewTelegramAdapter() (+4 more)

### Community 256 - "Community 256"
Cohesion: 0.33
Nodes (9): Context, Logger, Writer, loggerKey, LoggerFromContext(), LoggerFromCtx(), NewLogger(), NewLoggerWithWriter() (+1 more)
...
Cohesion: 0.22
Nodes (8): Checker Sign-Off, Color, Copywriting Contract, Design System, Phase 6 — UI Design Contract, Registry Safety, Spacing Scale, Typography
...
Cohesion: 0.22
Nodes (8): Checker Sign-Off, Color, Copywriting Contract, Design System, Phase {N} — UI Design Contract, Registry Safety, Spacing Scale, Typography
...
Cohesion: 0.22
Nodes (8): { checkLatestVersion }, fs, { isSemverNewer }, MANAGED_HOOKS, { PACKAGE_NAME }, path, result, staleHooks

### Community 286 - "Community 286"
Cohesion: 0.22
Nodes (7): ALL_PATTERNS, fs, INJECTION_PATTERNS, MARKDOWN_LINK_PATTERNS, path, stdinTimeout, SUMMARISATION_PATTERNS

### Community 287 - "Community 287"
Cohesion: 0.22
Nodes (5): fs, path, { spawnSync }, stdinTimeout, { tokenize }
...
Cohesion: 0.28
Nodes (5): HealthHandler, NATSConn, Context, Echo, Pool
...
Cohesion: 0.25
Nodes (7): Goal Achievement, Notes, Observable Truths, Phase 3: Ingest API & Queue Verification Report, Required Artifacts, Requirement Traceability, Test Coverage
...
Cohesion: 0.25
Nodes (7): Manual-Only Verifications, Per-Task Verification Map, Phase {N} — Validation Strategy, Sampling Rate, Test Infrastructure, Validation Sign-Off, Wave 0 Requirements
...
Cohesion: 0.39
Nodes (3): Registry, Dispatcher, RWMutex

### Community 332 - "Community 332"
Cohesion: 0.18
Nodes (10): Deferred Ideas, Established Patterns, Existing Code Insights, Implementation Decisions, Integration Points, Phase 07.1: Close gap: v1.0 audit gaps - Context, Phase Boundary, Reusable Assets (+2 more)
...
Cohesion: 0.29
Nodes (7): Anti-Patterns to Avoid, Architecture Patterns, Pattern 1: Tenant-Context Wrapper, Pattern 2: AES-256-GCM Envelope Encryption, Pattern 3: Buffered Batch Writer, Recommended Project Structure, System Architecture Diagram

### Community 351 - "Community 351"
Cohesion: 0.29
Nodes (7): Common Pitfalls, Pitfall 1: Partition by `workspace_id` instead of `created_at`, Pitfall 2: Encrypt API keys instead of hashing, Pitfall 3: Missing `key_id`/`key_version` columns, Pitfall 4: Reusing nonces in AES-GCM, Pitfall 5: Tenant-context omission in early queries, Pitfall 6: Audit buffer Close() race
...
Cohesion: 0.29
Nodes (6): Goal Achievement, Observable Truths, Phase 5: Official Channels & Smart Fallback Verification Report, Required Artifacts, Requirement Traceability, Test Coverage

### Community 354 - "Community 354"
Cohesion: 0.29
Nodes (6): Goal Achievement, Observable Truths, Phase 6: Webhook Delivery & DLQ Verification Report, Required Artifacts, Requirement Traceability, Test Coverage

### Community 355 - "Community 355"
Cohesion: 0.29
Nodes (5): DashboardHandler, Context, Pool, WorkspaceRepository, Querier
...
Cohesion: 0.33
Nodes (6): Code Examples, Echo v5 Setup with slog, Goose Embedded Migrations, Health/Readiness Endpoints, pgxpool + stdlib Bridge, pprof + expvar Setup

### Community 404 - "Community 404"
Cohesion: 0.33
Nodes (5): Blockers (must fix), ISSUES FOUND, Recommendation, Structured Issues, Warnings (should fix)
...
Cohesion: 0.40
Nodes (5): ARGUMENT_TAKING_FLAGS, BOOLEAN_FLAGS, isGitSubcommand(), path, tokenize()

### Community 423 - "Community 423"
Cohesion: 0.33
Nodes (5): 1. Architectural Summary & Principles, Design posture, Distributed-systems challenges identified, Functional shape, PRD analysis

### Community 424 - "Community 424"
Cohesion: 0.33
Nodes (5): 2. Technical Decisions, Communication, Libraries, Persistence, What we are *not* doing

### Community 425 - "Community 425"
Cohesion: 0.60
Nodes (5): IsTerminal(), TestIsTerminalNil(), TestIsTerminalNonTerminal(), TestTerminalError(), T
...
Cohesion: 0.40
Nodes (5): Alternatives Considered, Core, Development Tools, Standard Stack, Supporting
...
Cohesion: 0.60
Nodes (4): TestDeviceHandler_Construction(), TestDeviceHandler_Disconnect_EmptyJID(), TestDeviceHandler_GetQR_MissingPhone(), T
...
Cohesion: 0.50
Nodes (3): 07-01-SUMMARY, Accomplishments, Verification

### Community 489 - "Community 489"
Cohesion: 0.50
Nodes (3): 07-02-SUMMARY, Accomplishments, Verification

### Community 490 - "Community 490"
Cohesion: 0.50
Nodes (3): 07-03-SUMMARY, Accomplishments, Verification

### Community 491 - "Community 491"
Cohesion: 0.50
Nodes (3): 07-04-SUMMARY, Accomplishments, Verification
...
Cohesion: 0.67
Nodes (3): TestTelemetryHandler_Construction(), TestTelemetryHandler_Index_NilDeps(), T
...
Cohesion: 0.50
Nodes (3): 3. Directory Structure, Package dependency rules (enforced by `goimports` + review), Why this shape
...
Cohesion: 0.19
Nodes (15): Context, Logger, MessagePayload, S3Client, WhatsAppClient, T, isTerminalWhatsAppError(), NewWhatsAppAdapter() (+7 more)
...
Cohesion: 0.22
Nodes (8): Int64, Context, Device, Duration, JID, calcBackoff(), hashBytes(), parseJID()

### Community 1092 - "Community 1092"
Cohesion: 0.29
Nodes (9): Conn, Echo, JetStreamPublisher, T, WebhookDLQRepository, WorkspaceRepository, connectNATS(), setupWebhookRoutes() (+1 more)
...
Cohesion: 0.29
Nodes (7): Client, Context, ReadCloser, DownloadResult, DownloadAndValidate(), mimeToExt(), S3Client

### Community 1096 - "Community 1096"
Cohesion: 0.22
Nodes (8): 1. Queue Depth counter leak (ingestion lock) (`QUEUE-02`), 2. Plaintext whatsmeow device keys (`SEC-04`), 3. WABA Relative URL failure (`MEDIA-02`, `MEDIA-03`), 4. Fake Database Partitioning (`AUDIT-01`), 5. ClientOutdated version refresh (`WAWEB-06`), 6. Terminal status missing on LoggedOut (`WAWEB-07`), Gaps Analysis, Milestone v1.0 — Audit Report

### Community 1097 - "Community 1097"
Cohesion: 0.25
Nodes (7): Per-Task Verification Map, Phase 07.1 — Validation Strategy, Plan 07.1-01: Close gap: v1.0 audit gaps, Requirement Coverage Summary, Sampling Rate, Test Infrastructure, Validation Sign-Off

### Community 1098 - "Community 1098"
Cohesion: 0.29
Nodes (6): Goal Achievement, Observable Truths, Phase 07.1: Close gap: v1.0 audit gaps Verification Report, Required Artifacts, Requirement Traceability, Test Coverage

### Community 1099 - "Community 1099"
Cohesion: 0.33
Nodes (5): 1. Phase Completion Status, 2. Requirements Verification, 3. Integration & E2E Flows, Executive Summary, v1.0 Milestone Audit Report

### Community 1100 - "Community 1100"
Cohesion: 0.40
Nodes (4): Goal Achievement, Observable Truths, Phase 7: Media & Inbound Verification Report, Required Artifacts

## Knowledge Gaps
- **5176 isolated node(s):** `_runtime-launcher.snippet.sh script`, `fs`, `path`, `{ isSemverNewer }`, `{ checkLatestVersion }` (+5171 more)
...
- **Why does `New()` connect `Community 12` to `Community 0`, `Community 256`, `Community 130`, `Community 131`, `Community 10`, `Community 15`, `Community 25`, `Community 26`, `Community 27`, `Community 29`, `Community 158`, `Community 159`, `Community 425`, `Community 46`, `Community 558`, `Community 52`, `Community 1091`, `Community 1092`, `Community 1094`, `Community 1095`, `Community 79`, `Community 465`, `Community 89`, `Community 221`, `Community 98`, `Community 99`, `Community 109`, `Community 119`, `Community 120`, `Community 255`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 15` to `Community 0`, `Community 131`, `Community 3`, `Community 10`, `Community 12`, `Community 25`, `Community 26`, `Community 27`, `Community 29`, `Community 158`, `Community 159`, `Community 39`, `Community 43`, `Community 44`, `Community 46`, `Community 52`, `Community 187`, `Community 188`, `Community 65`, `Community 66`, `Community 1089`, `Community 1093`, `Community 89`, `Community 220`, `Community 95`, `Community 98`, `Community 99`, `Community 109`, `Community 119`, `Community 120`, `Community 255`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `Communities (1095 total, 115 thin omitted)` connect `Community 53` to `Community 493`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Are the 119 inferred relationships involving `New()` (e.g. with `getTestPool()` and `TestWABATemplateHandler()`) actually correct?**
  _`New()` has 119 INFERRED edges - model-reasoned connections that need verification._
